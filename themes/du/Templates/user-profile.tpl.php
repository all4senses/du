...
<div class="profile"<?php print $attributes; ?>>
  ...
  <?php 
    ...
    $user_name = $user_profile['field_full_name'][0]['#markup'];
    
    echo '<div id="user-caption">' , $user_name, '</div>', render($user_profile['user_picture']), render($user_profile['field_bio']),  '<div class="bottom-clear"></div>';
